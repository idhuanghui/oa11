...
class AdminbaseController extends AppframeController {
    ...
    protected function page($Total_Size = 1, $Page_Size = 0, $Current_Page = 1, $listRows = 6, $PageParam = '', $PageLink = '', $Static = FALSE) {
        ...
        $Page->SetPager('Admin', '<span class="fr">{first}{prev}&nbsp;{liststart}{list}{listend}&nbsp;{next}{last}</span>共<em>{recordcount}</em>条记录，当前第<em>{pageindex}/{pagecount}</em>页',
                array("listlong" => "6", "first" => "首页", "last" => "尾页", "prev" => "上一页", "next" => "下一页", "list" => "*", "disabledclass" => ""));
        return $Page;
    }
